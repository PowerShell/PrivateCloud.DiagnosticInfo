...
function Get-SddcDiagnosticInfo
{
    ...
    try {
        ...
        if ($IncludeProcessDump) {
            ...
            $JobCopyOut += Invoke-Command -ComputerName $($ClusterNodes).Name -ConfigurationName $SessionConfigurationName -JobName ProcessDumps -ArgumentList $ProcessLists {
        ...
        if ($IncludeGetNetView) {
            ...
            $ClusterNodes.Name |% {
                ...
                $JobCopyOut += Invoke-Command -ComputerName $_ -ConfigurationName $SessionConfigurationName -AsJob -JobName GetNetView {
        ...
        $JobStatic += $ClusterNodes.Name |% {
            ...
            Invoke-SddcCommonCommand -JobName "System Info: $NodeName" -InitBlock $CommonFunc -SessionConfigurationName $SessionConfigurationName -ScriptBlock {
                ...
                $NodeSystemRootPath = Invoke-Command -ComputerName $using:NodeName -ConfigurationName $SessionConfigurationName { $env:SystemRoot }
        ...
        $JobCopyOut += Invoke-Command -ArgumentList $IncludeLiveDump,$IncludeStorDiag -ComputerName $AccessNode -ConfigurationName $SessionConfigurationName -AsJob -JobName StorageDiagnosticInfoAndLiveDump {
        ...
        $JobCopyOut += Invoke-Command -ArgumentList $HoursOfEvents -ComputerName $($ClusterNodes).Name -ConfigurationName $SessionConfigurationName -AsJob -JobName Events {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAUHu0QjimaCQEf
# HzTJqTVdPqAIJrL7UcE4saomgwWlEaCCDXYwggX0MIID3KADAgECAhMzAAABhk0h
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIKwyTaTF8tNGK391QVBPKBuX
# ifxjqP4IoB2mrDDo6bSNMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAm7e2GWVl58D/WYBuZ8cH9MNj7ODLYQjq/UxQVS4gd9/ihXbivbVxvY8G
# xlYaWmrDkQ22oZ81Vksmv1KawQfC7Y0i6KoHm9b0uNBbqUhSClNwu7CILo0j+FAM
# /VkjOvIj5fzg3o6yRIpOQ6dT6GK/D6CNnQvX0QOfzIgD5D1usbcDIQvLYMrwC+Gi
# DncHU1Q2x4+4GKf0PX8s2NAWuILlVpxj4ldqOhtK7z6zR+dGh5N781nuq4TUEJyN
# o2z1uGabw+I4ZCokf1qm5nBSIKnFNb+Bv0JMkg/qWzDugGPyY3ZwibM2aFoTfdJh
# +rgVLx360kBEcJch7xahj6SQOLmGOKGCEvEwghLtBgorBgEEAYI3AwMBMYIS3TCC
...
# AwQCAQUABCCEZvllaUq3MohEsOWtP3TpD4DJss5hYGRv8K8djPR2lQIGXqbmO1kB
# GBMyMDIwMDUxMzIyMDIzNS40MjJaMASAAgH0oIHUpIHRMIHOMQswCQYDVQQGEwJV
...
# BgkqhkiG9w0BCQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIL4jqzbo
# lH2e6Mn/MspBtq4oE7ips+aIPPr4foUuOzgJMIH6BgsqhkiG9w0BCRACLzGB6jCB
...
# 9w0BAQsFAASCAQDrnKm9i0/Ut0qOfBVC758aOUATbVQHiTUlxfeidG/Qsa4iNMoP
# CSDy7LWGDliQ16Ca0yi3KZ/uP1hn5t8VBt+mtHyqO1Mj3uOlszz7ir8wcsrz5E26
# yiVNJXNvOzkRFVE6VMy8Jcm1W5MWAwYpWGx7G7539+dOY8cQmzAhHd9Iurl52g3c
# Y797s7USGdqvd/BsUDABWrIKITI+stNvvoHopEllCS/tchkzpGYCug8wOadGKT1L
# qhazgWzHnTf6pOyvYBEhVfQwI9fBiXcQ/eGP6JPi3kRoMTS3nVWNADugkXt0b/+T
# 8fTOJRy8xjIdgYXal7NKm4lYE20jl8v9/OF0
